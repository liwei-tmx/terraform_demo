...
locals {
  # EKS集群名
  cluster_name = "tf-cluster-demo"
  # EKS集群角色名
  cluster_role_name = "tf-cluster-demo"
  # EKS计算节点名
  node_name = "tf-node-demo"
  # EKS计算节点角色
  node_role_name = "tf-node-demo"
  # EKS计算节点使用的启动模板名
  launch_template_name = "tf-launch_template-demo"
